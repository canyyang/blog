  ...
  return (
    <Flex className={style.container}>
      ...
      <Flex className={style.rightbox} vertical={true} align='center'>
        <Flex justify='space-between' style={{width: '850px'}}>
          <Card className={`${style.card} ${style['left-card']}`} style={{width: '400px', height: '200px'}}>
            <Flex align='center' className={`${style['intro-title']}`}><img src='imgs/blacks.png' style={{width: '25px', marginRight: '5px'}} /> 阿阳@canyyang</Flex>
          ...
          <Card className={`${style.card}  ${style['right-card']}`} style={{width: '400px', height: '200px'}}>
        ...
        <Card className={`${style.card}  ${style['card-title']}`} style={{width: '850px'}}>🔧 个人项目</Card>
        <Flex justify='space-between' style={{width: '850px'}}>
        ...
        <Card className={`${style.card}`} style={{width: '850px', marginTop: '23px'}}>
          <Flex align='center' justify='space-between' className={style.blog}>
        ...
        <Card className={`${style.card}  ${style['card-title']}`} style={{width: '850px'}}>📞 与我联系</Card>
        <Flex justify='space-between' style={{width: '850px'}}>
          <Flex className={`${style.card}  ${style['contact']}`} style={{width: '400px', marginTop: '23px'}}><div className={`${style['contact-img']}`} style={{backgroundPosition: '0 0'}}></div><span> Email: canyangchen@126.com</span></Flex>
          <Flex className={`${style.card}  ${style['contact']}`} style={{width: '400px', marginTop: '23px'}}><div className={`${style['contact-img']}`} style={{backgroundPosition: '-32px 0'}}></div><span> QQ: 2357873118</span></Flex>
        </Flex>
      </Flex>
    </Flex>
  )
