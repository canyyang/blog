  ...
  return (
    <Flex className={style.container}>
      ...
      <Flex className={style.rightbox}  vertical={true} align='center'>
        <Flex justify='space-between' vertical={isMobile ? true : false} style={{width: '850px'}} align='center'>
        ...
        <Card className={`${style.card}  ${style['card-title']}`} style={{width: `${isMobile ? '94vw' : '850px'}`}}>🔧 个人项目</Card>
        <Flex vertical={isMobile ? true : false} justify='space-between' style={{width: `${isMobile ? '94vw' : '850px'}`}}>
        ...
        <Card className={`${style.card}  ${style['card-title']}`} style={{width: `${isMobile ? '94vw' : '850px'}`}}>📜 博客文章</Card>
        <Card className={`${style.card}`} style={{width: `${isMobile ? '94vw' : '850px'}`}}>
        ...
        <Card className={`${style.card}  ${style['card-title']}`} style={{width: `${isMobile ? '94vw' : '850px'}`}}>📞 与我联系</Card>
        <Flex justify='space-between' vertical={isMobile ? true : false} style={{width: `${isMobile ? '94vw' : '850px'}`}}>
